...
PGPASSWORD=$master_pw psql -h $host --user oph --dbname $db --command "grant select, insert, update, delete on all tables in schema ovara_virkailija to ovara_app;"
PGPASSWORD=$master_pw psql -h $host --user oph --dbname $db --command "alter default privileges in schema ovara_virkailija grant select, insert, update, delete on tables to ovara_app;"
PGPASSWORD=$master_pw psql -h $host --user oph --dbname $db --command "grant usage on schema pub to ovara_app;"
PGPASSWORD=$master_pw psql -h $host --user oph --dbname $db --command "grant select on all tables in schema pub to ovara_app;"
PGPASSWORD=$master_pw psql -h $host --user oph --dbname $db --command "grant select on all sequences in schema pub to ovara_app;"
PGPASSWORD=$master_pw psql -h $host --user oph --dbname $db --command "alter default privileges in schema pub grant select on tables to ovara_app;"
echo ""
echo "DONE!"
