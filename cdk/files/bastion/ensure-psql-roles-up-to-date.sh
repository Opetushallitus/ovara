...
PGPASSWORD=$master_pw psql -h $host --user oph --dbname $db --command "grant usage on schema public to ovara_app;"
PGPASSWORD=$master_pw psql -h $host --user oph --dbname $db --command "grant select on all tables in schema public to ovara_app;"
PGPASSWORD=$master_pw psql -h $host --user oph --dbname $db --command "grant select on all sequences in schema public to ovara_app;"
echo ""
echo "DONE!"
